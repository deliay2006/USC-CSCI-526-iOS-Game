...
class GameScene3: SKScene, SKPhysicsContactDelegate {
    ...
    override func didMoveToView(view: SKView) {
        ...
        textures.append(SKTexture(imageNamed: "fireball06"))
        textures.append(SKTexture(imageNamed: "fireball07"))
        textures.append(SKTexture(imageNamed: "fireball08"))
        textures.append(SKTexture(imageNamed: "fireball09"))
        textures.append(SKTexture(imageNamed: "fireball10"))
        textures.append(SKTexture(imageNamed: "fireball11"))
        textures.append(SKTexture(imageNamed: "fireball12"))
        textures.append(SKTexture(imageNamed: "fireball13"))
        textures.append(SKTexture(imageNamed: "fireball14"))
        
        
        
        oneAnimation = SKAction.repeatActionForever( SKAction.animateWithTextures(textures,timePerFrame: 0.1))
        sharpRock.runAction(SKAction.repeatActionForever(oneAnimation))
        sharpRock1.runAction(SKAction.repeatActionForever(oneAnimation))
        sharpRock2.runAction(SKAction.repeatActionForever(oneAnimation))
        
//        self.wind = self.assetViewController.initWind("wind0", position: CGPointMake(20, 400))
...
//        }
    ...
    func basketDidCollideWithBall(basket:SKSpriteNode,ball:SKSpriteNode){
        ...
        let anotherInt3 = NSUserDefaults.standardUserDefaults().integerForKey("myInt3")
        if(myInt3<anotherInt3 || anotherInt3 == 0){
            NSUserDefaults.standardUserDefaults().setInteger(myInt3, forKey: "myInt3")
        ...
        self.currentScoreLabel.text = "Your Score: " + self.assetViewController.scoreSystem(myInt3)
...
//        self.transparentButton.hidden = false
    ...
    func gameEnd(didWin:Bool){
        ...
        self.scoreLabel.text = "Highest Score: " + self.assetViewController.scoreSystem(NSUserDefaults.standardUserDefaults().integerForKey("myInt3"))
