...
@property (nonatomic, readonly) uint32_t toolKitCategory;
...
@property (nonatomic, readonly) uint32_t starCategory;
...
@property (nonatomic, strong) UILabel * __null_unspecified bloodLabel;
